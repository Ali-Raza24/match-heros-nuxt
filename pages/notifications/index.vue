  ...
  <NuxtLayout>
    <div class="flex lg:flex-row flex-col gap-4 mb-4 items-center justify-between">
      <h6 class="text-white text-base font-regular">
        Total Number of Notifications ({{ store.TotalNotifications }})
    ...
    <el-pagination background layout="prev, pager, next" :total="store.TotalNotifications"
      :page-size="store.perPageNotifications" :current-page="currentPage" @current-change="handleCurrentChange" />
  </NuxtLayout>
</template>
